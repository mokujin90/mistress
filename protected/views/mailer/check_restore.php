                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tbody><tr>
                                    <td align="center" valign="top">
                                        <h2 style="color: #00acec !important"><?=Yii::t('main','Подтверждение смены пароля')?></h2>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" valign="top">
                                        <p style="margin: 1em 0;">
                                            Вам необходимо подтвердить смену пароля для портала Iip. Для этого достаточно перейти по ссылке - Вам будет выслано письмо с паролем от Вашего аккаунта
