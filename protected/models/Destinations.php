...
class Destinations extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('price, contact_name, contact_phone, time_from, time_to', 'length', 'max'=>255),
			array('number', 'length', 'max'=>100),
			array('type', 'length', 'max'=>5),
			array('description', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, order_id, name, description, weight, price, contact_name, contact_phone, number, date, time_from, time_to, type', 'safe', 'on'=>'search'),
		);
	}
